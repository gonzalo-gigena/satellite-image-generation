...
x_full_rotation_time = 360 / x_deg_per_sec
y_full_rotation_time = 360 / y_deg_per_sec
z_full_rotation_time = 360 / z_deg_per_sec

# Calculate the LCM of the full rotation times
lcm_full_rotation_time = lcm(lcm(int(x_full_rotation_time), int(y_full_rotation_time)), int(z_full_rotation_time))
